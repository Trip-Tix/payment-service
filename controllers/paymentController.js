...
//     const ticketId = '1234567890'; // Replace with the ticket ID
//     const journeyDate = '01/01/2021'; // Replace with the journey date
//     const journeyTime = '12:00 PM'; // Replace with the journey time
//     const startingLocation = 'Dhaka'; // Replace with the starting location
//     const destinationLocation = 'Chittagong'; // Replace with the destination location

//     const busServiceName = 'Green Line Paribahan'; // Replace with the bus service name
//     const busCoachType = 'AC'; // Replace with the bus coach type
//     const busBrandName = 'Scania'; // Replace with the bus brand name
...
//     // Define the table header
//     const tableHeader = ['Name', 'Age', 'Gender', 'Phone', 'Seat', 'Price'];
...
//     // Define the passenger data (replace with your actual data)
//     const passengerData = [
//         ['John Doe', '30', 'Male', '123-456-7890', 'A1', '50'],
//         ['Jane Smith', '25', 'Female', '987-654-3210', 'B2', '55'],
//         // Add more passenger information rows as needed
//     ];
...
//     }
//     // Add the total price
//     const totalPrice = 1000; // Implement this function
//     page.drawText(`Total Price: Tk ${totalPrice}`, {
//         x: 400,
//         y: currentY - 10,
//         size: 15,
//         font: await pdfDoc.embedFont(StandardFonts.HelveticaBoldOblique),
...
//     // Add Transaction ID and Payment Method to the upper rectangle
//     const transactionId = '1234567890'; // Replace with your transaction ID
//     const paymentMethod = 'Credit Card'; // Replace with your payment method
...
//     // Save the PDF to a file or send it as needed
//     await fs.writeFile('ticket.pdf', pdfBytes); // Replace 'ticket.pdf' with the desired file name

//     console.log('Ticket saved to file');

//     res.status(200).json({
//         status: 'success',
//         message: 'Ticket saved to file',
//         data: req.body
//     });
// }
